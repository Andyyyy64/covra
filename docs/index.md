...
Covra is an E2E UX coverage dashboard for Playwright-powered Next.js apps. It collects coverage from the browser and the Next.js server process, remaps generated JavaScript back to source files, then presents the result by route/path first.
...
Covra v0.2.1 is production-ready for:
...
- route-first E2E UX dashboard output
